        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center">
                ...
                <div class="mx-auto mt-8 sm:mt-4 text-gray-200 md:mt-8 md:max-w-2xl md:text-center">
                    ...
                    <section aria-label="About Ben's background.">
                        <h2 class="lg:text-lg mt-4 mb-4 text-left">
                            About Me
                        </h2>
                        ...
                        <p class="indent-8 mt-4 mb-4 text-left">
                            ...
                            probably <a href="https://en.wikipedia.org/wiki/Apple_Pascal"> Apple Pascal, which was a derivative of 
                            <a href="https://en.wikipedia.org/wiki/UCSD_Pascal">UCSD Pascal</a>. 
                        </p>
